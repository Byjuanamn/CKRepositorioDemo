...
//  ejemplo
//
//  Created by Juan Martín Noguera on 3/9/14.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    CKContainer *container = [CKContainer containerWithIdentifier:@"iCloud.com.CloudKitNSCoder"];
    NSLog(@"%@", [container containerIdentifier]);
    
    CKDatabase *pubDB = [container publicCloudDatabase];
